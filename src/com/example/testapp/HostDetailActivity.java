...
public class HostDetailActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null) {
			...
			arguments.putString(HostDetailFragment.ARG_ITEM_ID, getIntent()
					.getStringExtra(HostDetailFragment.ARG_ITEM_ID));
			HostDetailFragment fragment = new HostDetailFragment();
			fragment.setArguments(arguments);
			getSupportFragmentManager().beginTransaction()
			.add(R.id.host_detail_container, fragment).commit();
		}
	}
